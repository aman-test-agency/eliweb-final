        ...
        >
          {LANGUAGES.map((l) => (
            <button
              ...
              title={l.label}
              className={`flex items-center gap-2 rounded-md px-2 py-1.5 transition hover:bg-foreground/8 ${
                activeLang === l.code ? "bg-foreground/10 ring-1 ring-border" : "bg-transparent"
              }`}
            >
              <span className={`fi fi-${l.flag}`} aria-hidden="true" />
              <span className="font-label text-[12px] font-semibold uppercase text-foreground">
